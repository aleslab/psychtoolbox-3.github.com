...
On [MacOSX](MacOSX) we use beamposition queries to improve accuracy of our timestamps  
...
On Linux, built-in [OpenML](OpenML) timestamping has the highest priority,  
